...
class BaseModel(Base):
    ...
    # 公共审计字段
    creation_date = Column(DateTime, nullable=False, default=tzu.get_now, comment="创建时间")
    created_by = Column(String(50), nullable=False, comment="创建人")
    last_update_date = Column(DateTime, nullable=False, default=tzu.get_now, onupdate=tzu.get_now, comment="修改时间")
